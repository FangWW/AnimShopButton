 ...
 */
class EasyAdapter<T>(private val layoutResId: Int, private val bindView: (View, T) -> Unit, private var list: List<T> = emptyList()) :
    ...
    class ViewHolder<in T>(view: View, private val bindView: (View, T) -> Unit) : RecyclerView.ViewHolder(view) {
